...
module Commands =
    ...
    let buildEncodeCmd (info: MediaFileInfo) (outputPath: string) : string list =
        ...
        [ "-hide_banner"
          "-y"
          "-i"; MediaFilePath.value info.Path
          "-c:v"; "libx264"
          "-preset"; Constants.Preset
          "-crf"; string Constants.Crf
          "-profile:v"; Constants.Profile
          "-level:v"; Constants.Level
          "-pix_fmt"; "yuv420p"
          "-g"; string gopSize
          "-keyint_min"; string fps
          "-bf"; string Constants.BFrames
          "-x264-params"; Constants.X264Params
          "-c:a"; "copy"
          "-map"; "0:v:0"
          "-map"; "0:a:0"
          "-movflags"; "+faststart"
